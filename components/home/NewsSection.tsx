  ...
  const newsItems = [
    {
      ...
      logoUrl: "https://www.thedailystar.net/themes/custom/swallow/logo.svg"
    },
    {
      id: 2,
      ...
      logoUrl: "https://media.prothomalo.com/prothomalo-bangla/2025-11-17/qix5skks/palo-bangla.svg"
    },
    {
      id: 3,
      ...
      logoUrl: "https://files.thedailycampus.com/images/logo.svg"
    }
  ];
    ...
    <section className="py-12 relative overflow-hidden z-10 w-full mb-12">
      <div className="container relative mx-auto px-4 md:px-6 mb-12">
        <div className="relative glass-section border border-white/10 hover:border-white/20 group">
          ...
          <div className="absolute top-0 left-0 -m-20 w-96 h-96 bg-rose-500/30 rounded-full blur-[100px] pointer-events-none" />
          <div className="absolute bottom-0 right-0 -m-20 w-96 h-96 bg-amber-500/25 rounded-full blur-[100px] pointer-events-none" />
              ...
              >
                <Link href={item.link} target="_blank" rel="noopener noreferrer" className="block group h-full">
                  <div className="h-full relative overflow-hidden rounded-[2rem] bg-[#050505] border border-orange-500/30 p-8 shadow-[0_0_30px_rgba(249,115,22,0.1)] transition-all duration-500 hover:scale-[1.03] hover:-translate-y-2 hover:shadow-[0_0_50px_rgba(249,115,22,0.4)] hover:border-orange-400/60 flex flex-col pt-16">
                    ...
                    {/* Media Logo / Source */}
                    <div className="absolute top-8 left-8 h-10 px-3 py-1.5 bg-white shadow-lg rounded-[0.75rem] flex items-center justify-center group-hover:scale-105 group-hover:-translate-y-1 transition-all duration-300 z-20">
                      <img
                        src={item.logoUrl}
                        alt={item.source}
