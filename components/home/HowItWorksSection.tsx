    ...
    <section className="py-12 relative overflow-hidden z-10">
      <div className="container relative mx-auto px-4 md:px-6 mb-12">
        <div className="relative glass-section border border-white/10 hover:border-white/20 group">
          ...
          <div className="absolute top-0 right-0 -m-20 w-96 h-96 bg-emerald-500/30 rounded-full blur-[100px] pointer-events-none" />
          <div className="absolute bottom-0 left-0 -m-20 w-96 h-96 bg-teal-400/25 rounded-full blur-[100px] pointer-events-none" />
